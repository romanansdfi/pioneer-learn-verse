...
const TestimonialCard: React.FC<{
  ...
  return <div className="bg-white p-6 rounded-lg shadow-md">
      <div className="flex items-start mb-4">
        {testimonial.image ? <div className="h-12 w-12 rounded-full overflow-hidden mr-4">
            <img src={testimonial.image} alt={testimonial.name} className="h-full w-full object-cover" />
          </div> : testimonial.initials ? <div className="h-12 w-12 rounded-full bg-pioneer-deep-blue text-white flex items-center justify-center mr-4 font-semibold text-sm">
...
const Testimonials: React.FC = () => {
  return <section className="py-16 px-4 md:px-8 lg:px-16 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-14 flex flex-wrap justify-center items-center gap-8 md:gap-16">
          <div className="text-xl font-bold text-gray-400">Math Wizards </div>
          <div className="text-xl font-bold text-gray-400">Science Explorers</div>
          <div className="text-xl font-bold text-gray-400">English Champions</div>
          <div className="text-xl font-bold text-gray-400">Future Innovators</div>
