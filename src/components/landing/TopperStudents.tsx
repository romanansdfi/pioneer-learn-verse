...
const topperStudents: Student[] = [
  ...
  },
  {
    ...
    description: "Won Gold Medal in National Science Olympiad and secured 97.8% in board examinations",
    score: "97.8%",
    rank: "1st",
    subjects: ["Science", "Mathematics", "Social Studies", "Hindi"],
    image: "https://images.unsplash.com/photo-1494790108755-2616c7e20093?auto=format&fit=crop&w=400&h=400&q=60",
    badge: "Olympiad Champion",
